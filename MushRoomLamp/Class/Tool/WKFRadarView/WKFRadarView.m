...
//        pulsingLayer.backgroundColor = [UIColor colorWithRed:92.0/255.0 green:181.0/255.0 blue:217.0/255.0 alpha:0.5].CGColor;
        ...
        opacityAnimation.values = @[[NSNumber numberWithDouble:0.6],[NSNumber numberWithDouble:0.4],[NSNumber numberWithDouble:0.3],[NSNumber numberWithDouble:0.2],[NSNumber numberWithDouble:0.2],[NSNumber numberWithDouble:0.2],[NSNumber numberWithDouble:0.2]];
//        opacityAnimation.keyTimes = @[[NSNumber numberWithDouble:0.0],[NSNumber numberWithDouble:0.2],[NSNumber numberWithDouble:0.3],[NSNumber numberWithDouble:0.5],[NSNumber numberWithDouble:0.7],[NSNumber numberWithDouble:0.8],[NSNumber numberWithDouble:1.0]];
