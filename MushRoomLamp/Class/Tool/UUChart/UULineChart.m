...
- (id)initWithFrame:(CGRect)frame withStartTime:(int) startTime
{
...
-(void)setXLabels:(NSArray *)xLabels
{
    ...
    for (int i=0; i<xLabels.count; i++) {
        ...
        UUChartLabel * label = [[UUChartLabel alloc] initWithFrame:CGRectMake(i * _xLabelWidth+UUYLabelwidth, self.frame.size.height - UULabelHeight, nWidth, UULabelHeight)];
        ...
        {
            UILabel *vline = [[UILabel alloc] initWithFrame:CGRectMake((i+0.5) * _xLabelWidth+UUYLabelwidth, self.frame.size.height - UULabelHeight-12, 0.5, 2)];
            vline.backgroundColor = [UIColor colorWithRed:133/255.0 green:133/255.0 blue:133/255.0 alpha:1];
...
-(void)strokeChart
{
    for (int i=0; i<_yValues.count; i++) {
        ...
        CGFloat xPosition = (UUYLabelwidth + _xLabelWidth/2.0 + _xLabelWidth * _startTime );
        CGFloat chartCavanHeight = self.frame.size.height - UULabelHeight*3;
